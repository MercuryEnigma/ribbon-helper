// Extracted from damage_modern.js for Gen 7 (Sun/Moon) use.
// All calculation logic is adapted directly from damage_modern.js with gen=7 hardcoded.
...
// --- Speed calculation for calculateAllMovesGen7 ---

export function computeGen7Speed(pokemon: ModernPokemon, weather: string, terrain: string): number {
  ...
  if (pokemon.status === "Paralyzed" && pokemon.curAbility !== "Quick Feet") speed = Math.floor(speed / 2) // gen 7+: /2
  if (pokemon.curAbility === "Chlorophyll" && weather.includes("Sun") ||
    ...
    pokemon.curAbility === "Slush Rush" && (weather.includes("Hail") || weather === "Snow") ||
