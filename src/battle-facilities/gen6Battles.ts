...
const ORAS_MODES: FacilityMode[] = [
  {
    ...
    maxBattle: 20,
    teams: [
      { name: "nq8r's Durant/Cloyster/Gliscor Team", url: 'https://pokepast.es/c431d238fc4a3e43', description: 'Recommended team (requires HA Truant Durant):', pokemon: ['Durant (Singles)', 'Cloyster (Singles)', 'Gliscor (Singles)'] },
      { name: "maasa's Kangaskhan/Aegislash/Garchomp Team", url: 'https://pokepast.es/23f6f33cf5db75cb', description: 'Most consistent (requires Aegislash):', pokemon: ['Kangaskhan-Mega (maasa Singles)', 'Aegislash (maasa Singles)', 'Garchomp (maasa Singles)'] },
      { name: "The Wrath of 'Khan", url: 'https://pokepast.es/e08a669b14a09bc3', description: 'Easiest to build (requires Aegislash):', pokemon: ['Kangaskhan-Mega (Wrath of Khan Singles)', 'Aegislash (Wrath of Khan Singles)'] },
      { name: "Ravage1995's Starmie/Scizor/Garchomp Team", url: 'https://pokepast.es/e30466994c0a8ac5', description: 'Alternative (requires Scizor):', pokemon: ['Starmie (Ravage Singles)', 'Scizor-Mega (Ravage Singles)', 'Garchomp (Ravage Singles)'] },
      { name: 'Cloyster vs Battle 50 Nita', url: 'https://pokepast.es/20442d86d8956eb8', description: 'For Battle 50 Battle Chatelaine Nita:', pokemon: ['Cloyster (Nita Singles)'] },
    ],
    ribbon: {
  ...
  },
  {
    ...
    maxBattle: 20,
    teams: [
      { name: "nq8r's Aron / Aromatisse TR Doubles Team", url: 'https://pokepast.es/ec414befed89b451', description: 'Recommended team (requires HA Gale Wings Talonflame and Aromatisse):', pokemon: ['Aromatisse (Doubles)', 'Aron (Doubles)', 'Talonflame (Doubles)', 'Gliscor (Doubles)'] },
      { name: 'Variant with less Friend Safari', url: 'https://pokepast.es/d66f3b78badb4991', description: 'Alternative team (requires Aromatisse):', pokemon: ['Aromatisse (Less FS Doubles)', 'Aron (Doubles)', 'Kangaskhan-Mega (Less FS Doubles)', 'Gliscor (Doubles)'] },
      { name: 'Jellicent variant', url: 'https://pokepast.es/fff1a801f1c925d2', description: 'Easiest to build:', pokemon: ['Aron (Rain Dance Doubles)', 'Jellicent (Jellicent Doubles)', 'Mawile-Mega (Jellicent Doubles)', 'Chansey (Jellicent Doubles)'] },
      { name: "Lumari's Team", url: 'https://pokepast.es/17b3a39974cba79b', description: 'Most consistent (requires Scizor):', pokemon: ['Weavile (Lumari Doubles)', 'Gardevoir-Mega (Lumari Doubles)', 'Gastrodon (Lumari Doubles)', 'Scizor (Lumari Doubles)'] },
      { name: "Crab Man's Team", url: 'https://pokepast.es/6954b4950a911664', description: "Alternative team:", pokemon: ['Raichu (Crab Man Doubles)', 'Azumarill (Crab Man Doubles)', 'Kangaskhan-Mega (Crab Man Doubles)', 'Hydreigon (Crab Man Doubles)'] },
      { name: 'TR Starmie', url: 'https://pokepast.es/19cd7ec868eb708c', description: 'For Battle 50 Battle Chatelaine Evelyn:', pokemon: ['Aron (Evelyn Doubles)', 'Starmie (Evelyn Doubles)'] },
    ],
    ribbon: {
      name: 'Skillful Battler Ribbon',
  ...
  },
  {
    ...
    ribbon: {
      name: 'Expert Battler Ribbon',
      description: 'Win the 50th battle against Chatelaine Evelyn in Super Doubles to earn the Expert Battler Ribbon. After 51 consecutive wins, you need to restart the streak to earn the ribbon.',
      icon: '/images/ribbons/expert-battler-ribbon.png',
    },
  },
]
