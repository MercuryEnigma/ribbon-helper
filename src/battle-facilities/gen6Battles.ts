...
const ORAS_MODES: FacilityMode[] = [
  ...
  },
  {
    ...
    teams: [
      ...
      { name: 'Jellicent variant', url: 'https://pokepast.es/fff1a801f1c925d2', description: 'Easiest to build:', pokemon: ['Aron (Jellicent Doubles)', 'Jellicent (Jellicent Doubles)', 'Mawile-Mega (Jellicent Doubles)', 'Chansey (Jellicent Doubles)'] },
